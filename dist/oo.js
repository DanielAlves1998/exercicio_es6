...
var Pokemon = /*#__PURE__*/function () {
  //o # torna o código privado, e não tem como alterar ele em nenhuma parte do código
...
var Pikachu = /*#__PURE__*/function (_Pokemon2) {
  //HERANÇA, herança pq tem ele mento pai e filho
  function Pikachu() {
    _classCallCheck(this, Pikachu);
    //um novo construtor, não precisa passar nenhum argumento porque ja conhecemos
    return _callSuper(this, Pikachu, ['Pikachu', 'elétrico']); //esse super é de (superior), é como se fosse uma função
  }
  ...
  return _createClass(Pikachu, [{
    ...
    value: function atacar() {
      //não precisa de um argumento porque já sei que é o choque do trovão
...
var pikachu = new Pokemon('pikachu', 'elétrico'); //só é possivel colocar os nomes aqui porque foi dado o tipo do construpor lá em cima
