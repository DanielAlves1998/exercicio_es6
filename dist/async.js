...
var funcaoMuitoPesadaPromise = new Promise(function (resolve, reject) {
  //o RESOLVE será chama do em caso de sucesso, e o REJECT em caso de falha. o=> é uma eron function
  try {
    var execucoes = 0;
    for (var i = 0; i < 1000000000; i++) {
      execucoess++;
...
//nova PROMISE
var promiseComParametros = function promiseComParametros(loguin, senha) {
  return new Promise(function (resolve, reset) {
    setTimeout(function () {
      // aqui foi criado o setTimeout e foi passado a função o calbec com () => {} usando o erou function =>, e como segundo argumento passamos o delei no caso 3000 (3 segundos)
      resolve("Logado com o usu\xE1rio: ".concat(loguin));
    }, 3000);
  });
};
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          promiseComParametros('daniel@gmail.com', 12341234).then(function (resultado) {
        ...
        case 9:
          ...
          console.log(_context.t0); //o E é de erro
        case 12:
          console.log("fim");
        case 13:
        case "end":
